...
_RESIDUAL_REGISTRY: dict[str, ResidualSpec] = {
    ...
    "operator_chain_type_mismatch": ResidualSpec(
        code="operator_chain_type_mismatch",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Operator chain has adjacent input/output type mismatch.",
        remediation_hint="Align each operator output_type with the next input_type.",
    ),
    "operator_chain_layer_mismatch": ResidualSpec(
        code="operator_chain_layer_mismatch",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Operator chain has adjacent layer mismatch.",
        remediation_hint="Ensure previous.layer_to equals next.layer_from for every pair.",
    ),
    "operator_chain_forbidden_final_output": ResidualSpec(
        code="operator_chain_forbidden_final_output",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Operator chain emits forbidden final output.",
        remediation_hint="Use only licensed final outputs for the final layer.",
    ),
    "operator_chain_missing_trace_composition": ResidualSpec(
        code="operator_chain_missing_trace_composition",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Operator chain lacks composed reverse trace.",
        remediation_hint="Compose local traces into one chain reverse trace.",
    ),
    "operator_chain_rank_overclaim": ResidualSpec(
        code="operator_chain_rank_overclaim",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Operator chain rank exceeds weakest-link ceiling.",
        remediation_hint="Clamp chain rank to the minimum operator rank.",
    ),
    "operator_chain_residual_erasure": ResidualSpec(
        code="operator_chain_residual_erasure",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Operator chain dropped residuals from local operators.",
        remediation_hint="Aggregate chain residuals as a non-erasing union.",
    ),
    "operator_chain_invalid": ResidualSpec(
        code="operator_chain_invalid",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Operator chain failed governed composition validation.",
        remediation_hint="Fix chain composition contract and local operator validity.",
    ),
    "quantity_number_without_unit": ResidualSpec(
        code="quantity_number_without_unit",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Quantity mention has a numeric value but no recognised unit.",
        remediation_hint="Bind a recognised unit to the number or annotate the span.",
    ),
    "quantity_unit_without_number": ResidualSpec(
        code="quantity_unit_without_number",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Quantity mention has a unit token but no numeric value.",
        remediation_hint="Bind a number to the unit or drop the orphan unit token.",
    ),
    "quantity_unit_ambiguous": ResidualSpec(
        code="quantity_unit_ambiguous",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Quantity mention unit could not be disambiguated.",
        remediation_hint="Resolve the unit alias before downstream normalization.",
    ),
    "quantity_word_number_unresolved": ResidualSpec(
        code="quantity_word_number_unresolved",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Arabic number word could not be resolved to a numeric value.",
        remediation_hint="Extend the Arabic number word lexicon or normalize manually.",
    ),
    "quantity_span_trace_missing": ResidualSpec(
        code="quantity_span_trace_missing",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Quantity mention lacks a span trace anchor.",
        remediation_hint="Anchor every QuantityMention to a raw_prompt span.",
    ),
    "quantity_extraction_payload_invalid": ResidualSpec(
        code="quantity_extraction_payload_invalid",
        family=ResidualFamily.FRACTAL_OPERATOR,
        severity=ResidualSeverity.BLOCKER,
        blocks_certificate=True,
        default_message="Quantity extraction payload structure is invalid.",
        remediation_hint="Validate required fields and field types before consumption.",
    ),
