...
Bayani / AFJG هو نظام حوكمة معرفية للتحقق من الادعاءات والنصوص العربية ومخرجات النماذج ومخرجات تدقيق طلبات الدمج، ويُصدر فقط الأحكام النهائية التالية:
...
## تحليل تطور المشروع عبر جميع طلبات الدمج (من #1 إلى #99)
...
- **تقييم نطاق الحزمة (metadata تشغيلية):**
  - المسار العلمي = HYPOTHESIS (أدلة جزئية مع حدود الإغلاق الشكلي).
  - المسار الصناعي للإنتاج = HYPOTHESIS، مع أهلية نطاق تجريبي محكوم.
